...
class SecurityService {
	...
	async getContainsPerms({
        ...
        // console.log('rolePerm', rolePerm.listName, key, rolePerm)
				if (rolePerm.listName === key) {
					// console.log('rolePerm.listName,key', rolePerm.listName, key)
					if (!_.isEmpty(rolePerm.permType.permType)) {
						// console.log('permType', rolePerm.permType.permType)
	...
	async hasPermission({
		...
		await this.getContainsPerms({
			...
			console.log('containsPerms', containsPerms)
